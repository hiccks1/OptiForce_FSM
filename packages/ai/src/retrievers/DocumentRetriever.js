...
exports.DocumentRetriever = exports.DRIFTY_FILE_CONTRACT_SYMBOL = void 0;
var BaseRetriever_1 = require("./BaseRetriever");
var module_1 = require();
exports.DRIFTY_FILE_CONTRACT_SYMBOL = module_1.DRIFTY_FILE_DECLARATION_SYMBOL;
var DocumentRetriever = /** @class */ (function (_super) {
    __extends(DocumentRetriever, _super);
    function DocumentRetriever(prisma) {
        var _this = _super.call(this) || this;
        _this.prisma = prisma;
        _this.name = 'document-retriever';
        _this.version = 2;
        return _this;
    }
    DocumentRetriever.prototype.perform = function (ctx, input) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.prisma.document.findMany({
                                where: __assign({ companyId: ctx.companyId, deletedAt: null }, (input.documentId && { id: input.documentId })),
                                take: (_a = input.limit) !== null && _a !== void 0 ? _a : 10,
                    ...
                    case 1:
                        ...
                        items = documents.map(function (doc) {
                            ...
                            return ({
                                ...
                                data: ((_a = doc.metadata) !== null && _a !== void 0 ? _a : {}),
                            });
                        });
                        return [2 /*return*/, {
                                outcome: 'success',
